...
// ?======================================================
//!klasik yollarla string tanmlanırsa bu string primitive değişkendir.
...
//!Non-primitive Sting tanımlama;
const str5 = new String('Non-primitive Sting');
...
console.log(s2,s3);
/*sonradan eklediklerimiz, değeri tekrar yazdırınca gitti*/
...
console.log(copyTarkan, typeof copyTarkan, copyTarkan.length); //* String'i array haline getirdi. (Tek elemanlı)
...
let link1 = "https://www.youtube.com/watch?v=b7vfp5G4brE";
let link2 = link1.replace('www.youtube.com/watch?v=','youtu.be/');
console.log(link2);
